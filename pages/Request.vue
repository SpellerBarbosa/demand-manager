...
<template>
    <Profile />
    <section
        class="w-full min-h-[77vh] bg-gray-200 flex items-center justify-center p-4 lg:absolute top-0 lg:w-[70%] lg:ml-[30%] lg:h-[100vh]">
        <form class="w-full max-w-xl bg-white rounded-2xl shadow-lg p-6 flex flex-col space-y-6"
            ...
            <label for="description_service" class="flex flex-col">
                ...
                <textarea name="description_service" id="description_service" placeholder="Descreva sua solicitação"
